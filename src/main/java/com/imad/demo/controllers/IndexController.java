...
public class IndexController {
    ...
    public String index(Model model, @PathVariable(name = "from", required = false) String from,
        ...
        result[0] = value +" " + currencies1.getFirst()+ " = <br/>";
        result[1] = (firstValue*value/secondValue) +" "+ currencies1.getSecond();
        /**
    ...
    public String convert(@ModelAttribute("selectedcurrencies") Currencies currencies){
        System.out.println(currencies.getFirst() +" "+ currencies.getSecond()+" "+ currencies.getAmount());
